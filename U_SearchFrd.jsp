  ...
  <div class="header">
    <div class="header_resize">
      <div class="logo style7">
        <h2 align="center" class="style8">Hate Speech on Twitter A Pragmatic Approach to Collect Hateful and Offensive Expressions and Perform Hate Speech Detection</h2>
      </div>
